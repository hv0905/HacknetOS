...
const HackEmail Email[] = {
        HackEmail(L"初次联系", L"Bit", L"Hi. \n"
                                   L"我不认识你, 而且很遗憾的是我也没机会再认识你了, 但是如果你读到这封邮件, 那就意味着你还有机会来挽救这一切. \n"
                                   L"我现在深陷危机, 留给我的时间已经不多了. 有件事我想求你帮我. \n"
                                   L"但在这之前, 还有件更重要的事情需要你尽快处理, 越快越好. \n"
                                   L"现在这个状态的Hacknet操作系统并不应该发布出去...  ..你的电脑里马上就会有一个追踪软件自动激活, 赶快删掉它. \n"
                                   L"连接到你自己的节点(在网络图中的绿色节点), 然后找到并删除\"SecurityTracer.exe\". \n"
                                   L"当你完成时, 回复这个邮件就行. \n"
                                   L"快快快! \n"
                                   "\n"
                                   "-Bit\n"
        ...
        HackEmail(L"让我们来一起获取一些工具", L"Bit", L"很好 - 你现在应该安全了! 至少在你的电脑上...  \n"
                                           "\n"
                                           L"在我们开始之前, 你需要获取一些工具 - 只使用porthack是无法侵入你将来发现的大部分电脑的...  至少你入侵不了那些你感兴趣的东西. \n"
                                           "      \n"
                                           L"你应该从调查我朋友的服务器开始 - 他自称自己是\"Viper(毒蛇)\" - 听起来很可怕是吧? 老实说...  他干这行水平不怎么样, 但他总是有一些实用的代码. \n"
                                           "\n"
                                           L"入侵他的电脑对你来说应该不是问题 - 问题在于能否找到有用的文件. \n"
                                           "\n"
                                           L"在大多数情况下, 你可以忽略掉一些关于登陆记录, 程序的存储文件, IRC日志等等的这种\"普通\"文件. 像这种后缀为\".exe\"的文件才是你所寻找的. \n"
                                           "\n"
                                           L"你可以使用命令\"scp\"下载任何文件. \n"
                                           "\n"
                                           L"祝你好运 - 完成之后给我回信! \n"
                                           L"毒蛇作战基地服务器：176.198.61.104\n"
                                           "      \n"
                                           "--Bit\n"
                                           "0", 2, MODE_PURE_MISSION, &MissionCheckService::check_mission_2),
        HackEmail(L"初试牛刀", L"Bit", L"首先祝贺你! \n"
                                   L"说实话...  .你这样回复我, 也不知道你到底成功了没, 不过既然你正在读这封邮件意味着你至少发现了一些东西, 我先假定你找到的那程序是有用的. \n"
                                   "\n"
                                   L"我给你准备了一个小游戏, 让你试试你找到的新工具. 说实话, 我做这游戏可花了不少时间  -  -  我差点以为我要把这游戏带进坟墓里了. \n"
                                   "\n"
                                   L"这个服务器的安全性对你来说应该不是太高, 我想让你黑进去, 找到我的帐号, 然后删掉它. \n"
                                   "\n"
                                   L"你可能会需要使用你的新工具. 你可以通过输入\"程序名 端口号\"来调用它, 就像这样: \n"
                                   "\n"
                                   L">sshcrack 22\n"
                                   L" ^文件名   ^端口号\n"
                                   "    \n"
                                   L"黑掉你找到的端口. \n"
                                   "\n"
                                   L"对了, 给你提醒一下, 当你输入\"ssh\"然后按下Tab键就会自动补全命令, 这适用于所有的命令. \n"
                                   "\n"
                                   L"祝你好运! \n"
                                   "\n"
                                   L"Bitwise 测试PC@210.175.139.250\n"
                                   "\n"
                                   "--Bit\n"
                                   "0", 3, MODE_PURE_MISSION, &MissionCheckService::check_mission_3),
        HackEmail(L"善始善终", L"Bit", L"好样的! 从现在开始事情变得越来越复杂了. \n"
                                   L"我需要你帮我一个忙. \n"
                                   L"最近我因一点点小马虎而给自己惹了不少麻烦. 这就是为什么我给你写这封邮件. 总而言之, 我的意思是, 有几台电脑上有一些我本不想存放在那里的操作日志. \n"
                                   L"你一定要记住这点 -- 不要忘记删除你的操作日志. 如果你之前从没删过, 那就从现在开始. 你在任何现代的操作系统上所做的一切都会被跟踪记载在日志文件夹(~/log)下. 只需要进入这个文件夹, 使用\"rm *\"命令删除所有信息即可. 永远不要忘记这点. \n"
                                   L"Anderson的卧室电脑:247.112.153.237\n"
                                   "--Bit\n"
                                   "0\n", 4, MODE_PURE_MISSION, &MissionCheckService::check_mission_4),
        HackEmail(L"生涯起点", L"Bit", L"好样的! 如果你收到这封邮件, 说明你做的很好... 恩, 也许这一切真的是值得的. \n"
                                   L"我对你抱有的期望是不是太大了? 也许吧. \n"
                                   L"我知道我没有充裕的时间来一点点教你, 你要学的东西太多了. 所以, 我的决定如下. \n"
                                   L"有一个叫'Entropy'的组织目前正在招收新成员. 他们会教你更多黑客知识. 当你的黑客技术足以帮我完成我的夙愿时, 我会再联系你. \n"
                                   L"为了进入Entropy, 你需要绕过一个代理服务器, 在你已经得到管理员权限计算机上运行几个shell(使用shell命令), 它可以用来过载代理服务器. \n"
                                   L"这并不难, 你只需要在你有管理员权限的计算机上运行shell命令, 再在目标计算机上运行overload命令即可. \n"
                                   L"我的测试PC上也有相关的文档.\n"
                                   L"祝你好运... \n"
                                   L"还有, 谢谢. \n"
                                   L"Entropy测试服务器:199.59.149.230\n"
                                   "--Bit\n"
                                   "0\n"
                                   "\n", 5, MODE_PURE_MISSION, &MissionCheckService::check_mission_5),
        HackEmail(L"任务完成", L"Entropy", L"你好,\n"
                                       "\n"
                                       L"首先, 祝贺你成功通过了Entropy黑客组织的考试! 当然了, 这种程度的考试对于一个经验丰富的黑客来说是小事一桩. 然而令人惊讶的是, 能通过这场考试的人并不多. \n"
                                       L"在你正式加入我们组织之前, 我们必须对你的能力进行进一步的考验.\n"
                                       L"最近, 有一家新闻网站摆明了同我们的对立立场. 我们希望你能临时瘫痪他们的服务器. 作为测试你能力的第二项任务, 我们要求你搞垮他们的新闻版块. 如果可以的话, 不要破坏无关的服务器和那些与Entropy无关的文章 -- 我们没必要把事情做的那么绝. \n"
                                       L"这项任务可不是仅仅让你删除文章这么简单 -- 我们还要搞垮他们的程序. \n"
                                       L"Slash-Bot 新闻服务器:183.198.0.210\n"
                                       "-Tex", 6, MODE_PURE_MISSION, &MissionCheckService::check_mission_6),
        HackEmail(L"欢迎", L"Entropy", L"\n"
                                     L"恭喜, \n"
                                     L"你出色及时地完成了你的第一项任务, 让我们见识到了你的能力. 现在, 我诚挚地欢迎你来到Entropy黑客组织. \n"
                                     L"在我们的资源服务器里, 你可以找到管理员账户的详细资料. 作为组织送给你的见面礼, 你可以去资源服务器里面随意下载你所需要的程序, 同时记得阅读我们组织的宗旨. 一旦你准备好了, 请回复这封邮件. 我会给你安排一些真正有挑战的任务. \n"
                                     L"再次的恭喜你通过测试. \n"
                                     L"Entropy资源服务器:196.21.2.201\n"
        ...
        HackEmail(L"RE:欢迎", L"Entropy",
                  ...
                  L"当你有空的时候, 就去接受并完成你的第一项任务吧. \n"
                  L"届时我将会再次联系你来评估你的任务进度. \n"
                  L"-Tex\n", 8),
        HackEmail(L"Point_Clicker", L"Entropy MailBot", L"你好, \n"
                                                        L"我现在有点郁闷, 但更倒霉的是, 我的那些同事没一个能帮的上忙的. \n"
                                                        L"虽然我很反感向外界寻求帮助, 但是我只能这么做了. \n"
                                                        L"把你们组织介绍给我的那个人向我保证你们会保密, 所以我就简要说明一下: 我在PointClicker里已经刷到无敌了, 我希望我能再刷一遍二周目来证明我在这个游戏里的王者地位. 然而这个游戏并没有重置按钮. \n"
                                                        L"我希望你能黑进游戏服务器删掉我的存档, 这样我就能再爽一次了. 我的用户名是\"Mengsk\". 你要是想的话, 在你删之前可以先感受一下我的存档有多屌. \n"
                                                        L"即将\"脱坑\"的, Mengsk\n"
                                                        L"PointClicker服务器:38.228.127.137\n"
                                                        "-M", 8, MODE_PURE_MISSION,
                  &MissionCheckService::check_mission_8),
        HackEmail(L"经典的反黑客攻击", L"Entropy MailBot", L"你好黑客, \n"
                                                   L"\"PP市场\"公司最近雇佣了一名自由黑客, 他入侵了竞争对手公司的服务器窃取了一些敏感信息(我们猜测应该是邮件形式的简历列表). 他把这些简历从对手公司的服务器里删掉了, 并将简历转交到雇主公司的招聘部门. \n"
                                                   L"这种商业间谍行为很明显是在给黑客的声誉抹黑. 虽然我们对他们公司之间的竞争并不感兴趣, 但是\"PP市场\"公司雇佣黑客的消息已经传遍了整个网络, 所以我们要确保\"PP市场\"这次吃不了兜着走. \n"
                                                   L"我们不知道那些文件的确切名字, 所以你找的时候要费点心思. 记住, 你要找到并删除的是一份被偷走的邮件列表 -- 它们可能被加密或归档了. 注意, PP公司可能会对此有所防范, 他们应该会采取相应的安全措施. \n"
                                                   L"PP市场:234.228.181.58\n"
                                                   L"-Entropy 管理员", 9, MODE_PURE_MISSION,
                  &MissionCheckService::check_mission_9),
        HackEmail(L"重返校园", L"Entropy MailBot", L"各位黑客, \n"
                                               L"Milburgh高中的管理层联系到我们, 希望我们能悄悄地搞到他们IT部门员工的管理员密码, 以此就IT部门都保存了学生的什么数据来展开一项调查. \n"
                                               L"当你入侵时, 务必使一切数据保留原样 -- 任何的篡改将会影响到管理层人员的判断. \n"
                                               L"而你所需要做的, 就是黑进去, 找到密码, 然后清除你的操作日志, 把密码回复给我. 至于如何把密码交给学校的管理层就不需要你操心了. \n"
                                               L"祝你好运, \n"
                                               L"Milburg高中IT办公室：92.24.43.165\n"
                                               L"-Entropy 管理员", 10, MODE_REPLY_MISSION,
                  &MissionCheckService::check_mission_10),
        HackEmail(L"RE:重返校园", L"Entropy MailBot", L"你确定? \n"
                                                  L"*******... . 我不知道想出这种密码的人是天才还是白痴, 还是说两者都是? \n"
                                                  L"妈的, 我是说, 当初我也找到了这个密码, 而且我的核验脚本显示这个密码的正确的, 然而我还在继续独自破解那些星号! \n"
                                                  L"这就他妈的尴尬了... .这你叫我怎么去跟学校的头头们解释? \n"
                                                  L"不论怎么说... 问题解决了, 你做的不错. \n"
                                                  L"-管理员", 11),
        HackEmail(L"结局", L"EdgeNeko", L"恭喜! 你通关了! 就目前而言的话.\n"
                                      L"这个游戏其实是对HackNet游戏的一个纯C++控制台模仿, 事实上我们只实现了原版游戏极小部分的开头内容, 后面还有更多精彩剧情没在本游戏中呈现.\n"
                                      L"如果你对这类游戏感兴趣的话, 你一定要去玩玩原版的Hacknet (hacknet-os.com)\n"
                                      L"总之, Thanks for playing! 如果有什么想说的欢迎来discussion聊, 或者直接给我发邮件.\n"
                                      L"-EdgeNeko", 11),
...
HacknetApplication *StarterCreator::createStarterOS()
{
    ...
    auto IRC_Log_583977_8977 = new HackTxtFile("IRC_Log:583977(8977)",
                                               L"\n"
                                               L"<DannyB> 我在街上碰到个妹子问我是否还保有处男之身(if i was saved)\n"
                                               "\n"
                                               L" <DannyB> 我跟她说几分钟前我刚经过一个检查点\n"
                                               "\n"
                                               L" <DannyB> 如果我死了我可以在那加载存档\n"
                                               "\n"
                                               L" <DannyB> 她一脸懵逼");
    auto Speech_node = new HackTxtFile("Speech_node",
                                       L"\n"
                                       L"周五向全公司作报告的演讲笔记, 千万别忘了! ! ! \n"
                                       L"领潮争先, 共创未来\n"
                                       "\n"
                                       L"－Facebook集成: 在技术时代, 我们必须将集成Facebook作为我们游戏企划关键, 以此来减少开支, 最大化利润. \n"
                                       L"－协同增效: 为了最大化工作效率, 我们必须通力合作, 以求双赢. \n"
                                       L"－社会媒体: 我们必须构建社会媒体的知识基础, 通过电子商务在以客户为导向的领域摘得头筹. \n"
                                       L"－超频CPU: 我们要紧随潮流, 扩展社会内容渠道, 提高网络带宽, 来提高线上占有率, 让公司收入翻两番. \n"
                                       L"－质量驱动路线: 授权方案让我们在 Web 2.0 上获得了许多令人惊讶的特色. (我认为这足以称为独立于因特网之外的第二个因特网, 周五之前同 Paul 一起再探讨一下? )(顺手让他帮我修好我的打印机)(顺手也问一下为什么我的打印机驱动文件夹是加密的)\n"
                                       L"－未来路线图: 自顶而下的电子化处理方式, 将我们的客户基础成功变现, 重新划分市场, 提高公司收入. ");
    ...
    Viper_home->AppendFile(new HackTxtFile("EmailDraft.txt", L"爸爸, \n"
                                                             L"    很抱歉之前没有及时给你回信 - 我在学校真的很忙 - 今年非常难熬, 不过我想我熬过来了. \n"
                                                             L"    我这次找你其实是想问你要点钱 - 我们学校今年有个新项目, 它叫 \"FTPBounce.exe\", 这个程序特别有用! 不过这个程序也很贵, 而且上次你给我的钱我也花完了... .IT这些项目软件都非常的贵. \n"
                                                             L"    能不能再给我打2000$? 我真的很需要. \n"
                                                             "\n"
                                                             L"    谢谢! \n"
                                                             L"    爱你的儿子, \n"
                                                             "    Tim"));
    ...
    Bitwise_home->AppendFile(new HackTxtFile("doc_shells.txt",
                                             ...
                                             "\n"
                                             L"代理服务器最广为人知的缺点就是它的存储上限, 一旦代理服务器的存储空间占满, 它就无法再阻止数据流的通过. \n"
                                             "\n"
                                             L"为了利用这个缺陷, 黑客和测试人员往往在其他计算机上运行Shell(通常使用\"shell\"指令). 当你在足够多的肉鸡上运行了shell后, 就可以连接到目标计算机并使用shell的\"overload\"功能来发动泛洪攻击, 用大量垃圾数据填满目标的代理服务器, 这样就可以让有害的数据流通过. \n"
                                             "Shell: \n"
                                             L"Shell是运行在单一主机上的低内存占用的小型进程, 可以用任何连接方式在本地对它进行操控. \n"
                                             L"这个极其方便的程序在许多任务中都是极其有用的, 当然它们能干什么取决于运行的shell的种类. \n"
                                             "\n"
                                             L"常规跨网络的功能有: \n"
                                             "\n"
                                             "Overload(过载):\n"
                                             L"过载用于测试网络和代理服务器, 这个功能可以使得运行shell的节点向目标机器发起泛洪攻击 - 用大量垃圾网络流量占满代理服务器的内存并耗尽其CPU时间.  \n"
                                             "\n"
                                             L"使用shell命令可在节点计算机上运行shell(因为需要进行网络操作, 必须有管理员权限), 使用overload命令即可使所有节点对目标计算机发起过载攻击.\n"
                                             L"使用shellkill可以断开与所有节点的连接, 在下次使用时必须重新连接所有节点. 直接结束shell进程有着同样的效果."));
    ...
    Anderson_Documents->AppendFile(new HackTxtFile("charlog.txt", L"[HotRice] 准备好出去浪了吗? \n"
                                                                  ...
                                                                  L"[Kiah] 你准备好去死了吗\n"
                                                                  L"[M4cr0b4t] 哈哈哈\n"
                                                                  L"[HotRice] 闭嘴, Johnson! \n"
                                                                  L"[HotRice] 忘了你上次打翻花生酱的事情了? \n"
                                                                  L"[M4cr0b4t] 别提那次的事情了\n"
                                                                  L"[HotRice] 就那一次就够你受的了\n"
                                                                  L"[HotRice] 有谁知道Hellerphant在哪里吗? \n"
                                                                  L"[Kiah] 没有人知道他去哪了\n"
                                                                  L"[Kiah] 我估计是有个魔法怪物把他抓走了. \n"
                                                                  L"[HotRice] 严肃点, 我们的计划被打乱了. \n"
                                                                  L"[HotRice] 为什么每次我担心的事情总会发生? "));
